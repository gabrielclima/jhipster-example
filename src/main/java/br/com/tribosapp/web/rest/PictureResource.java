...
public class PictureResource {
	...
	@Timed
	public ResponseEntity<Picture> uploadPicture(@RequestParam(name = "file") MultipartFile file,
		...
		picture.setFile(Picture.generateFilename(file.getOriginalFilename()));
		...
		try {
			FileUtils.writeByteArrayToFile(new File(Picture.FOLDER + picture.getFile()), file.getBytes());
		} catch (IOException e) {
			e.printStackTrace();
			return ResponseEntity.badRequest()
