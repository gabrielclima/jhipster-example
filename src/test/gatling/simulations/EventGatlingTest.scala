...
class EventGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Event entity")
        ...
        .repeat(2) {
            ...
            .post("/api/events")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "eventId":null, "eventName":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "period":"SAMPLE_TEXT", "createdAt":"2020-01-01T00:00:00.000Z", "tags":"SAMPLE_TEXT", "link":"SAMPLE_TEXT", "latitude":null, "longitude":null, "picture":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
